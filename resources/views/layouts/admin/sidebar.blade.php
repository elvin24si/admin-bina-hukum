<div class="sidebar pe-4 pb-3">
    <nav class="navbar bg-light navbar-light">
        <a href="index.html" class="navbar-brand mx-4 mb-3">
            <h4 class="text-primary"><i class="fa fa-file-alt me-2"></i>SI-HUKUM</h3>
        </a>
        <div class="navbar-nav w-100">

            <div class="nav-section-title text-muted px-3 mt-2 mb-1">
                MAIN
            </div>
            ...
            @if (auth()->user()->role === 'admin')
                <div class="nav-section-title text-muted px-3 mt-3 mb-1">
                    MASTER DATA
                </div>
            ...
            <a href="{{ route('logout') }}" class="btn btn-danger mx-3 mt-2">
